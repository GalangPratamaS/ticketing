    ...
    <div class="wrapper">   
                ...
                <form id="pesanticket" name="pesanticket" action="{{ route("pesanticket") }}" method="post">
                  ...
                  <div class="card-body">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-12">
                                          <label class="btn btn-primary active col">
                                              <input type="radio" name="paymentMethod" data-id="1" checked
                                                  autocomplete="off">
                      ...
                      <ol>
                        ...
                        <li>kartu kredit : 3% dari jumlah total Transaksi + Rp 1.665</li>
                        <li>QRis : 3% dari jumlah total Transaksi</li>
                      </ol> --}}
                  </div>
      ...
      <div class="container">
        <div class="wrapper">
          ...
          <h2 class="text-center text-white">Powered By</h2>
          <p class="text-center text-white">Galuh Mas Karawang</p>
          <img src="{{ asset('img/logo galuhmas grup.png') }}" class="img-fluid" alt="">
        </div>
        </div>
      </div>
  <!-- ======= Header ======= -->
  ...
  <script src="{{ asset('js/jquery-redirect.js') }}"></script> 
       ...
       $(document).ready(function () {
           ...
           $(".datepicker").on('change', function () {
              ...
              //  $(".grand span").html("Grand total Rp.");
               ...
               $.ajax({
                   url: "{{ route('ticket').'?_token='.csrf_token() }}",
                   data: {
                       tanggal: tanggal
                   },
                   type: 'post'
    ...
    $(document).ready(function() { 
      ...
      $('#pesanticket').on('submit', function (e) {
                  ...
                  $.ajax({
                      url: "{{ route('pesanticket').'?_token='.csrf_token() }}",
                      type: "POST",
