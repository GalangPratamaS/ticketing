...
<div id="app">
  ...
  <main id="main">
    ...
    color: rgb(51, 51, 51);">Pilih tanggal kedatanganmu</div> <br>
                <v-date-picker :locale="{ id: 'id',  masks: { weekdays: 'WWW' } }" :model-config="modelConfig" mode="date" title-position="left" color="blue" :min-date='new Date(2022,7,17)' :max-date='new Date(2022, 8, 30),' v-model='selectedDate'>
                ...
                <div class="card mt-2 ticketitem" style="width: 100%; margin: 20px;">
        ...
        function showTicket(date){
          ...
          $.ajax({
              ...
              success: function (result) {
                  ...
                  var data = result.datas; //datas prop is an array
                  for (var i = 0; i < data.length; i++) {
                      console.log(data[i].ticket_name);
                      $('.ticketitem').append('aku sayang gadis')
                  }
                  // console.log(result);
              }
